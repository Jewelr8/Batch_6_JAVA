...
public class Amodifier_1 {
    /*
       public variables and methods are accessible accross the project
       private variabls and methods are accessbile only its own class.
       To solve this issue we use encapsulation

       No access/packagePrivate variables and methods are accessbile only within its own package
